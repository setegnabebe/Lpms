...
if(!isset($_SESSION["username"]) || ($_SESSION["department"]!='Procurement' && !(isset($_SESSION["managing_department"]) && in_array("Procurement",$_SESSION["managing_department"]))&& $_SESSION["additional_role"]!=1 && $_SESSION["department"]!='Owner'))
{
